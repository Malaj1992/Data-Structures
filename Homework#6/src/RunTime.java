...
public class RunTime implements RunTimeInterface {
    ...
    public void setTimeUnits(TimeUnits timeUnits) {
        ...
        switch (timeUnits)
        {
            case Seconds : base = (long) Math.pow(10,9);//check this one in a different way.
                break;
            case MilliSeconds : base = (long)Math.pow(10,6);
                break;
            case MicroSeconds : base = (long)Math.pow(10,3);
                break;
            case NanoSeconds : base =(long) Math.pow(10,0);
                break;
        }

        switch (timeUnits)
        {
            case Seconds : dest = (long)Math.pow(10,9);
                break;
            case MilliSeconds : dest = (long)Math.pow(10,6);
                break;
            case MicroSeconds : dest = (long)Math.pow(10,3);
                break;
            case NanoSeconds : dest = (long)Math.pow(10,0);
                break;
        }
